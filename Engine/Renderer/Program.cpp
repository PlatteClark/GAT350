...
namespace squampernaut
{
    ...
    bool Program::Create(std::string filename, ...)
    {
        ...
        if (!vertex_shader.empty())
        {
            ...
            auto vshader = g_resources.Get<squampernaut::Shader>(vertex_shader, GL_VERTEX_SHADER);
            AddShader(vshader);
        }
        ...
        if (!fragment_shader.empty())
        {
            ...
            auto fshader = g_resources.Get<squampernaut::Shader>(fragment_shader, (void*)GL_FRAGMENT_SHADER);
            AddShader(fshader);
        }
